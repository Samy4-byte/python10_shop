...
#
# SET_NULL - при удалении категории, значение поля categoty для связанных продустов станет null
#
# SET_DEFAULT - при удалении категории, значение поля categoty для связанных продуктов заменяет на дефолт
#
# PROTECT
# RESTRICT
